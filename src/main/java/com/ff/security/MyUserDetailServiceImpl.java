...
import com.ff.dao.ResourcesMapper;
...
//		System.err.println("-----------MyUserDetailServiceImpl loadUserByUsername ----------- ");
		...
		//取得用户的权限
		com.ff.model.User users = userMapper.querySingleUser(username);
		if  (users==null)  
	...
	// 取得用户的权限
	private Set<GrantedAuthority> obtionGrantedAuthorities(com.ff.model.User user) {
		List<Resources> resources = resourcesMapper.getUserResources(String.valueOf(user.getId()));
